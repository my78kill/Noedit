...
# Bot config
TOKEN = "8420975632:AAHisA7j_rR0CcSam_XUcUp97mHuBbX637Y"

# Owner + Friends IDs (sabko ek list me rakho)
SUPER_ADMINS = [8316921366, 8432654205, 8389656418, 7448958077, 7325608028, 8452694781, 6495116917, 7594293383, 5971805747, 8237950787, 6948506211, 6571717987, 8306273466]  # aur IDs yaha add karo
